...
export default function Home(){
 ...
 return <main className={displayMode?'wrap tv':'wrap'}>
  ...
  <section className="card pickBoard"><h2>Game 1 Picks: 🇨🇦 Canada vs 🇿🇦 South Africa</h2><p className="muted">Family fun mode: picks stay open even after kickoff/final. Realtime totals update for everyone.</p><div className="pickTotals"><div><b>🇨🇦 Canada</b><span>{pickCounts.Canada}</span></div><div><b>🇿🇦 South Africa</b><span>{pickCounts.SouthAfrica}</span></div></div></section>
  <div className="grid">
